    ...
    public class ClientController : Controller
    {
        ...
        public JsonResult Update(Client theClient)
        {
            ...
            return Json(
                ...
                {
                    StatusCode =
                        clm.UpdateClient(theClient.Id, theClient.Name, theClient.LastName1, theClient.LastName2,
                            theClient.PenaltiesNumber.ToString(), theClient.PlaceResidence, theClient.MedicalHistory,
                            theClient.BornDate.ToString(), theClient.PhoneMum, theClient.Password)
                }, JsonRequestBehavior.AllowGet);
        }
